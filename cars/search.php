        ...
        <div class="container">
            <section class="mt-5">
                <div class="card mb-3">
                    <div class="card-body">
                        Search Car : <?php echo $search; ?>
                    </div>
                </div>

                <?php
                    $i = 1;
                    $rows = mysqli_query($conn, "SELECT * FROM car WHERE car_name LIKE '%$search%'")
                ?>
                ...
                <div class="card mb-3">
                    <div class="row g-0">
                        ...
                        <div class="col-md-11">
                            <div class="card-body">
                                <h5 class="card-title"><a href="view.php?carid=<?php echo $row["id"]; ?>" class="text-decoration-none text-secondary"><?php echo $row["car_name"]; ?></a></h5>
